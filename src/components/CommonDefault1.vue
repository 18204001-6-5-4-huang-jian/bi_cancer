  ...
  watch: {
    activeIndex:function(val){
       ...
       let value = '';
        ...
        this.$axios_http({
                url:SERVER_NAME +"/statistical/queryScreenData",
                method: "post",
                data:{
                  cancerType:params,
                },
                ...
                if(res.data.success){
                    this.total = res.data.result.dataList[0].screenNum;
                    this.percent = (res.data.result.dataList[0].screenRate*100).toFixed(2);
